...
<head>
    ...
    <title><?php echo e(__('movies.favorites')); ?> - <?php echo e(__('movies.title')); ?></title>
...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="<?php echo e(route('favorites.index')); ?>">
    ...
    <div class="container mt-4">
        <h2 class="mb-4">
            <i class="fas fa-heart text-danger me-2"></i><?php echo e(__('movies.favorite_movies')); ?>
        ...
        <div id="favorites-container">
            ...
            <div id="empty-favorites" class="text-center py-5" style="display: none;">
                ...
                <p class="text-muted"><?php echo e(__('movies.no_favorites')); ?></p>
                <a href="<?php echo e(route('movies.index')); ?>" class="btn btn-primary">
                    <i class="fas fa-film me-1"></i><?php echo e(__('movies.search_movies')); ?>
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">
                                <small class="text-muted">
                                    <strong><?php echo e(__('movies.type_label')); ?>:</strong> ${movie.Type.charAt(0).toUpperCase() + movie.Type.slice(1)}
                                </small>
                            </p>
...
</html><?php /**PATH C:\xampp\htdocs\movies_web\resources\views/favorites/index.blade.php ENDPATH**/ ?>